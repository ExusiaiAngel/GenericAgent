...
COMMANDS = {
    ...
    "tui": {
        ...
        "desc": "启动终端图形界面，支持多会话、/btw、/continue、/export 等命令",
    ...
    "web": {
        "help": "启动 Web 界面 (stapp)",
        "desc": "启动 Streamlit Web 聊天界面，用浏览器访问",
        "cmd": ["python", "-m", "streamlit", "run", "{FRONTENDS}/streamlit/stapp.py"],
    },
    "pet": {
        "help": "启动桌面宠物 v2",
        "desc": "启动 Tkinter 桌面宠物（带皮肤系统）",
        "cmd": ["python", "{FRONTENDS}/desktop/desktop_pet_v2.pyw"],
    },
    "status": {
        "help": "检查运行状态",
