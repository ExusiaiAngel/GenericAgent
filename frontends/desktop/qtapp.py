...
# Add project root so `from agentmain import ...` and `from frontends.*` work
_qt_proj_root = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
if _qt_proj_root not in sys.path:
    sys.path.insert(0, _qt_proj_root)
