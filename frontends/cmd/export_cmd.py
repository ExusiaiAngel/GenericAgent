...
def _ensure_cmd_path():
    """Add frontends/cmd/ to sys.path so sibling imports (continue_cmd) work.

    chatapp_common.py normally does this before any cmd module is imported,
    but export_cmd should be safe to import standalone.
    """
