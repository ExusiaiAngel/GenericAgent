...
class GenericAgentTUI(App[None]):
    ...
    def _do_continue_restore(self, path: str) -> str:
        sess = self.current
        from frontends.cmd.continue_cmd import reset_conversation, restore
        try:
...
def _warn_mintty():
    ...
    if direct_mintty:
        print(
            ...
            "    - Windows Terminal Git Bash: wt -p \"Git Bash\" python frontends/tui/tuiapp_v2.py\n"
            "    - Windows Terminal:          wt python frontends/tui/tuiapp_v2.py\n"
            "    - CMD:                       python frontends\\tuiapp_v2.py\n"
            "    - PowerShell:                python frontends/tui/tuiapp_v2.py\n"
            "\n"
